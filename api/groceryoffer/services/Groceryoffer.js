...
module.exports = {
  ...
  /**
   * Promise to fetch a/an groceryoffer.
   *
   * @return {Promise}
   */
  ...
  /**
   * Promise to count groceryoffers.
   *
   * @return {Promise}
   */
  ...
  /**
   * Promise to add a/an groceryoffer.
   *
   * @return {Promise}
   */
  ...
  /**
   * Promise to edit a/an groceryoffer.
   *
   * @return {Promise}
   */
  ...
  /**
   * Promise to remove a/an groceryoffer.
   *
   * @return {Promise}
   */
  ...
  /**
   * Promise to search a/an groceryoffer.
   *
   * @return {Promise}
   */
